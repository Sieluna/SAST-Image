...
public unsafe struct _ImageFile : IDisposable
{
    private byte* _content;
    private readonly long _length;

    private _ImageFile(byte* content, long length)
    {
        _content = content;
        _length = length;
    }
    ...
    public readonly Stream Stream
    {
        ...
        {
            if (_content == null)
                throw new ObjectDisposedException(nameof(_ImageFile));
    ...
    public static _ImageFile Create(Stream stream)
    {
